(function (jQuery){
    ...
    jQuery(document).ready(function(){
        ...
        jQuery(document).ready(function(){
            var videoLink = document.querySelector('.video-open');
            ...
            // Function to play the video when clicking the video link
            jQuery('.video-open').on('click', function(e){
                e.preventDefault();
                if (!videoIsPlaying) {
                    video.play();
                    videoIsPlaying = true;
            ...
            // Function to check if the click is outside the video element
            jQuery(document).on('click', function(e){
                if (!jQuery(e.target).closest('.trailor-video').length) {
                    stopVideo();
                }
            });
        
            // Append the video element to the document
            jQuery('.trailor-video').append(video);
        });
